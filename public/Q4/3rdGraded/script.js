function plotPoint(x0, y0, x, y) {  //CHANGE 7: DECLARE x0 x y0 y

    let in1 = document.getElementById("in1"); //CHANGE 8: DECALRE THESE THINGIES TOO
    ...
    point.style.position = "absolute"; /* CHANGE 9: USE PROPER STYLE ACCORDING TO COMMENT --
    control where to place the div on the screen using left and bottom of position:absolute */

    //CHANGE 10: FIX STYLING BY ADDING .
  ...
  } //CHANGE 6: Function plotPoint is not closed
